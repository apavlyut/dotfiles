...
# alias hpd='git add .; git add -u; git commit -am "hotfix"; git push heroku-dev master;'
...
alias hpd='echo "pusher-dev"; git add --all; git add .; git add -A; git add -u; git commit -m "pusher by heroku-dev"; git push heroku-dev master;'
